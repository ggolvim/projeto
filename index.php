<?php
  require 'config.php';
  include 'src/Servico.php';
  
  $Servico = new Servico($mysql);
  $servicos = $Servico->exibirTodos();
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    <meta charset="utf-8">
    <title>Alan Spa Beleza e Estética</title>
...
<body>
        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center">
                    <small><i class="fa fa-phone-alt mr-2"></i>+55 92 8569 6787</small>
                    <small class="px-3">|</small>
                    <small><i class="fa fa-envelope mr-2"></i>alanspa@gmail.com</small>
                </div>
            </div>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    <a href="index.html" class="nav-item nav-link active">Inico</a>
                    <a href="service.html" class="nav-item nav-link active">Serviçios</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Mais</a>
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="appointment.html" class="dropdown-item">Agendamento</a>
                            <a href="opening.html" class="dropdown-item">Cronograma</a>
                            <a href="team.html" class="dropdown-item">Quem somos</a>
                ...
                <div class="carousel-item position-relative active" style="min-height: 100vh;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h3 class="display-3 text-capitalize text-white mb-3">Massagems</h3>
    ...
    <div class="container-fluid px-0 py-5 my-5">
        <div class="row mx-0 justify-content-center text-center">
            <div class="col-lg-6">
                <h6 class="d-inline-block bg-light text-primary text-uppercase py-1 px-2">Nossos serviçios</h6>
            ...
            <?php foreach($servicos as $servico): ?>
                <div class="service-item position-relative">
                    ...
                    <div class="service-text text-center">
                        <h4 class="text-white font-weight-medium px-3"><?php echo $servico['tipo']; ?></h4>
                        <p class="text-white px-3 mb-3">
                            <?php echo substr($servico['descricao'],0,200); ?>
